...
function buildCards(
  ...
  return [
    ...
    },
    {
      ...
      value:
        metrics
          .pendingCompanyPricingOrders,
      description:
        "OS criadas pelo funcionário",
      icon: WalletCards,
    ...
    },
    {
      ...
      value:
        metrics
          .waitingExecutionOrders,
      description:
        "Prontas para entrar em rota",
      icon: ClipboardList,
    ...
    {
      title:
        "Rotas planejadas hoje",
      value:
        metrics.plannedRoutesToday,
      description:
        "Rotas previstas para hoje",
      icon: Map,
      href: "/routes/dashboard",
    },
  ];
