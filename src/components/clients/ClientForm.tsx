        ...
        {position ? (
          ...
          >
            ...
            <DialogPrimitive.Close
              ...
              className="absolute right-5 top-5 z-30 grid h-9 w-9 place-items-center rounded-lg text-slate-500 transition hover:bg-slate-100 hover:text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 disabled:cursor-not-allowed disabled:opacity-50 sm:right-7 sm:top-7"
            >
              <X className="h-5 w-5" />
            </DialogPrimitive.Close>
            ...
            <main ref={scrollContainerRef} className="min-h-0 flex-1 overflow-x-hidden overflow-y-auto overscroll-contain">
              <div className="space-y-6 px-4 py-5 pb-8 sm:px-8 sm:py-7 sm:pb-10">
                ...
                <ClientAddressesSection addresses={addresses} pending={savingAddress} onAddAddress={handleAddAddress} />
                  ...
                  <div className="flex items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-4 text-sm leading-6 text-amber-800">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-xs leading-5 text-amber-700">
                        Este cliente não deverá receber novas ordens de serviço, rotas ou planos até que seu cadastro seja reativado.
                      </p>
                    </div>
                  </div>
                ) : null}
            ...
            <ClientDetailsFooter
              ...
              deleting={deleting}
              canDeactivate={Boolean(onDeactivate)}
              canReactivate={Boolean(onReactivate)}
        ...
        description={
          <>
            <p>
              ...
              será removido definitivamente da empresa.
            </p>

            <p className="mt-2">
              Esta ação não poderá ser desfeita. A exclusão só será concluída se o cliente não possuir ordens de serviço vinculadas.
            </p>
          </>
        }
