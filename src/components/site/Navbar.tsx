    ...
    <header className="sticky top-0 z-40 w-full border-b bg-white/90 backdrop-blur">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <div className="h-9 w-9 rounded-xl btn-brand text-white grid place-items-center font-bold">
            P
          </div>
        ...
        <nav className="hidden md:flex items-center gap-7 text-sm">
          ...
          <Link
            ...
            className="rounded-lg btn-brand  px-4 py-2 text-white font-medium hover:bg-blue-700"
          >
            Começar grátis
          </Link>
        </nav>
        ...
        <div className="md:hidden">
          <Link
            href="/login"
            className="rounded-lg btn-brand px-3 py-1.5 text-white text-sm font-medium hover:bg-blue-700"
          >
            Entrar
          </Link>
        </div>
