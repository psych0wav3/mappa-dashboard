...
CREATE TABLE "public"."Technician" (
    ...
    "uf" TEXT,
    "userId" UUID,
    "phone_digits" TEXT DEFAULT regexp_replace(COALESCE(phone, ''::text), '\D'::text, ''::text, 'g'::text),
...
-- CreateIndex
CREATE INDEX "VisitInstance_planId_idx" ON "public"."VisitInstance"("planId" ASC);
...
-- AddForeignKey
ALTER TABLE "public"."VisitInstance" ADD CONSTRAINT "VisitInstance_planId_fkey" FOREIGN KEY ("planId") REFERENCES "public"."VisitPlan"("id") ON DELETE CASCADE ON UPDATE CASCADE;
